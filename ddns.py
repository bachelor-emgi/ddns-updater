...
record_name="electrum.pepelum.site"                                      # Which record you want to be synced
ttl=60                                            # Set the DNS TTL (seconds)
proxy="false"                                       # Set the proxy to true or false
sitename="pepelum"                                         # Title of site "Example Site"
...
############################################################################################################
## Set the record identifier from result, set static IP which should not be edited, modified by this script
############################################################################################################
static_ip=""
record_identifier=$(echo "$record" | jq -r ".result[] | select(.content != \"$static_ip\") | .id")
